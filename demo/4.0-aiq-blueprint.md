...
is served by the AI-Q backend and opened in the user's browser** (laptop/desktop) —
it is **not** inside the NemoClaw sandbox. The sandbox agent calls AI-Q's REST
...
1. **Sandbox agent** (OpenClaw) calls AI-Q as a tool, sending an HTTP request to
   `http://172.18.0.1:8000/generate`.
