...
<<<<<<< HEAD
| 2.0 | [Telegram Setup](2.0-telegram-bridge.md) | OpenClaw agent via Telegram — setup, use cases, model switching |
| 2.1 | [Telegram Heartbeat](2.1-telegram-heartbeat.md) | Sandbox health pings via OpenClaw skill + cron |
| 2.2 | [Telegram hourly nudge](2.2-telegram-hourly-nudge.md) | NemoClaw + Telegram: **philosopher-nudge** skill, LLM nudge via cron |
=======
