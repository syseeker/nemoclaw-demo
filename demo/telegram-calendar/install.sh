...
usage_exit() {
  ...
  echo ""
  echo "  Installs Google Calendar integration via gog CLI for Telegram + Calendar demo"
...
echo ""
echo -e "${CYAN}  ╔══════════════════════════════════════════════════════════╗${NC}"
echo -e "${CYAN}  ║  Telegram + Google Calendar for NemoClaw                ║${NC}"
echo -e "${CYAN}  ║  Calendar CRUD via Telegram                           ║${NC}"
echo -e "${CYAN}  ╚══════════════════════════════════════════════════════════╝${NC}"
echo ""
...
# Calendar-only: we only re-add google_calendar below
...
# Append Google Calendar policy block only (match openshell YAML format)
google = """\
  google_calendar:
...
rm -f "$POLICY_FILE"
ok "Policy applied (google calendar)"
...
echo ""
echo "  Service: Google Calendar (read/create/update/delete)"
echo ""
echo "  Next steps:"
echo "    1. Start Telegram bridge: nemoclaw start"
echo "    2. DM your bot: \"What's on my calendar today?\""
echo "    3. Try: \"Schedule a meeting on Friday at 2pm\""
echo "    4. Try: \"Cancel my 4pm meeting\""
echo ""
