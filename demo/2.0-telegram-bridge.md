# Demo 2.0: Telegram — Setup & Use Cases
...
> **Reference**: [Set Up Telegram](https://docs.nvidia.com/nemoclaw/latest/deployment/set-up-telegram-bridge.html)
...
See [**Demo 2.1 — Telegram Heartbeat**](2.1-telegram-heartbeat.md) for full
...
[Demo 2.1](2.1-telegram-heartbeat.md) for the template, and
[Demo 2.2](2.2-telegram-hourly-nudge.md) for another worked example using
the `philosopher-nudge` skill.
